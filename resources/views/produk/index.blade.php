    ...
    function editForm(url) {
        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-form [name=id_kategori]').val(response.id_kategori);
                $('#modal-form [name=harga_beli]').val(response.modal.modal_product);
                $('#modal-form [name=harga_jual]').val(response.produk.price);
                // $('#modal-form [name=id_discount]').val(response.id_discount);
